...
buttons = {
    '434e02f5-0679-47d8-afb7-7e74ba8b0f0a': ['wohnzimmer', '1', 'on'],
    '9b85666c-ff81-4c8c-95d8-9034b74e9c57': ['wohnzimmer', '1', 'up'],
    '2cdf8ceb-d272-44fb-ad7e-a9903045633a': ['wohnzimmer', '1', 'down'],
    '86ccd746-e412-4089-81ab-882c4826bdaf': ['wohnzimmer', '1', 'off'],

    '40d45630-a6a3-461c-bbb9-240788c87910': ['wohnzimmer', '2', 'on'],
    '49b46ed1-a774-4656-8456-ec262b07a375': ['wohnzimmer', '2', 'up'],
    'bdaf080a-e651-4e30-bfe6-1e169eb9b6f4': ['wohnzimmer', '2', 'down'],
    '6133ace3-7a9e-4de8-a1a6-ec0f6bf9c3c4': ['wohnzimmer', '2', 'off'],
...
def get_lights(room, include_slaves=False):
    ...
    if include_slaves and room == "all":
